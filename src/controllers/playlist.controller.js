...
const getUserPlaylists = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, userPlaylist, "Playlist(s) Fetched"));
});
...
const getPlaylistById = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, fetchedPlaylist, "Playlist Fetched"));
});
...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (error instanceof ApiError) {
      ...
      return res
        .status(500)
        .json(new ApiResponse(500, null, "Check video or playlist ID"));
    }
  }
});
